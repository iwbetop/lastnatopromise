  ...
  export default async function Achievement(){
    ...
    return(
        ...
        <CardHeader>
            ...
            <CardDescription>Customize your achievement</CardDescription>
        </CardHeader>
        <CardContent>
            <div className="">
                {user?.achievement.map(item => (
                    <div className="w-full py-3">
                        <div className="flex justify-between items-center px-2">
                            ...
                            <FormState formState={DeleteAchievement}>
                ...
                <DialogContent>
                    ...
                    <FormState formState={AddAchievement}>
                        ...
                        <InputControl>
                            ...
                            <Input type="date" name="achievedDate"/>
                        </InputControl>
                        </FormControl>
                        <InputControl>
